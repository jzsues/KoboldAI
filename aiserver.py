...
def general_startup(override_args=None):
    ...
    parser.add_argument("--load_in_8bit_threshold", action='store', default=6, help="set's load_in_8bit_threshold value", type=float)
